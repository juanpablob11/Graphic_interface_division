...
public class SubReservation_generic_holder2 extends JPanel{
	...
	public SubReservation_generic_holder2(String generic_holder_str, JComboBox<Object> comboBoxGeneric) {
		...
		// Move the buttons to the east side of the sub-label holders
			...
			this.add(comboBoxGeneric, BorderLayout.EAST);
